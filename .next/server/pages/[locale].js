...
function About() {
  ...
  const {
    classes: text
  } = (0,common/* useText */.XK)(); // const isDesktop = useMediaQuery(theme.breakpoints.up('lg'));
...
const useStyles = (0,tss_react_mui__WEBPACK_IMPORTED_MODULE_0__.makeStyles)({
  ...
  property: {
    ...
    [`& .${classes.logo}`]: {
      width: 64,
      height: 64,
      background: `url(${(public_images_decoration_frame_deco_png__WEBPACK_IMPORTED_MODULE_1___default())}) no-repeat`,
...
const caseData = [{
  ...
  bg: imgAPI/* default.agency.9 */.Z.agency[9],
            ...
            children: [/*#__PURE__*/jsx_runtime_.jsx((external_react_scroll_animation_wrapper_default()), {
              ...
              children: /*#__PURE__*/(0,jsx_runtime_.jsxs)((Paper_default()), {
                ...
                children: [/*#__PURE__*/jsx_runtime_.jsx((Typography_default()), {
                  variant: "h6",
                  display: "block",
                  children: t('agency-landing.office_branch')
                }), /*#__PURE__*/(0,jsx_runtime_.jsxs)((Grid_default()), {
                  container: true,
                  children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)((Grid_default()), {
                    item: true,
...
/* harmony import */ var components_About__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(1329);
/* harmony import */ var components_Services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(6594);
/* harmony import */ var components_Testimonials__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(7115);
/* harmony import */ var components_Expertise__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(2701);
/* harmony import */ var components_CaseStudies__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(8051);
...
const imgAPI = {
  ...
  agency: ['https://via.placeholder.com/964x723/1071ef/FFFFFF', '/images/aboutus.png', // '/images/logos/VeronaLogo.png',
